...
if (isset($_POST['order'])) { 
    ...
    $sql = "INSERT INTO `narudzbine` (ukupna_cena, vreme_narucivanja, broj_stola, ime_firme, detalji, napomena) VALUES ('$konacna_cena', '$vreme_narucivanja', '$broj_stola', '$ime_firme', '$detalji', '$napomena')";
